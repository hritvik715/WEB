...
two.addEventListener('contextmenu', () => {//imp->sirf left click karne se kuch nhi hoga right click kro tab jaake color change hoga
    two.classList.toggle("blue");
})

three.addEventListener('dblclick', () => {//imp->double click karne se axn hoga
    three.classList.toggle("teal");
})



four.addEventListener('mousedown', () => {//it is like click event
...
ten.addEventListener('mouseup', () => {//it is just like clcik
